...
```{r plotsmarggpd, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align = 'center', fig.width = 5, fig.height = 3}
plot(uncgpd)
```
...
```{r plotsadfest, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width = 4, fig.height = 2.5, fig.align = 'center'}
...
```{r plotsrcest, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width = 3.5, fig.height = 3.5, fig.align = 'center'}
# plot of the ADF estimation based on the unconstrained Hill estimator
plot(rch)
```
...
```{r plotsrcgof, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align = 'center',fig.width = 4}
plot(rch_gof)
```
