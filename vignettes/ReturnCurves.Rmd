...
increasing the probability of converging towards the global maximum.
...
# nboot set to 50 for computational time < 5s
rch_unc <- rc_unc(rch, blocksize = 1, nboot = 50, nangles = 150, alpha = 0.05)
