...
#' @param k polynomial degree for the Bernstein-Bézier polynomials used in the estimation of the angular dependence function using the composite likelihood method; default set to 7
...
#' 
#' @details
#' this function estimates the return curve given by \mjdeqn{RC(p):=\{(x, y) \in \mathbb{R}^2: \text{Pr}\left(X>x, Y>y\right)=p\}.} ... talk about how it connects to the estimation of the adf and the methods used, reference the est_lamb function
#' 
#' @rdname returncurve
#' 
#' @references to do
