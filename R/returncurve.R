...
#' 
#' @details This function estimates the return curve given by \deqn{RC(p):=\brace(x, y) \in \mathbb{R}^2: \text{Pr}(X>x, Y>y)=p\brace.} ... talk about how it connects to the estimation of the adf and the methods used, reference the est_lamb function
#' 
#' @rdname returncurve
#' 
#' @references to do
