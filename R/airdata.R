#' Air pollution data
#'
#' @description Air pollution data from Marylebone, London (UK), for the winters (December to February) of 1998 to 2005. 
#' It contains daily measurements of air pollutant concentrations of NOx and
...
#' }
#' 
#' @source \code{airdata} is a subset of the data provided in the \code{openair} package.
#' 
#' @keywords datasets
#' 
NULL